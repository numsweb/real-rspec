...
describe PropertiesController do
  ...
  let(:valid_attributes) { { "title" => "My Title", "description" => "Property Description", "city_name" => "City name", "price" => 100000} }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested property" do
        ...
        Property.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
